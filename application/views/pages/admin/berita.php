            ...
            <!-- Content Header (Page header) -->
                ...
                <div id="breadcrumb">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Daftar konten</li>
                    </ul>
                </div>
                <div class="main-header-title clearfix">
                    ...
                    <div class="page-title">
                        <h3 class="no-margin">DAFTAR KONTEN</h3>
                                        ...
                                        <?php $i = 1; foreach ($berita as $key => $berita): ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td align="center"><a href="<?php echo base_url('admin/edit-berita/'.$berita['id']);?>"><i class="fa fa-edit"></i></a>
													<a href="<?php echo base_url('admin/hapus-berita/'.$berita['id']);?>">&nbsp;|&nbsp;<i class="fa fa-trash-o"></i></a>
													</td>
                                                </tr>
                                            </tbody>
                                        <?php endforeach; ?>
