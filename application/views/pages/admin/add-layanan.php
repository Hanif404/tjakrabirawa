            ...
            <div class="content-wrapper">
                ...
                <div id="breadcrumb">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Add Layanan</li>
                    </ul>
                </div>
                <div class="main-header-title clearfix">
                    ...
                    <div class="page-title">
                        <h3 class="no-margin">ADD LAYANAN</h3>
                        ...
                        <div class="col-md-12">
                            <div class="box box-success">
                                ...
                                <div class="box-body pad">
                                    <form action="<?php echo site_url('admin/create-layanan');?>" method="post" enctype="multipart/form-data">
