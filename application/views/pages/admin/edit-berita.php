            ...
            <div class="content-wrapper">
                ...
                <div class="main-header-title clearfix">
                    ...
                    <div class="page-title">
                        <h3 class="no-margin">UPDATE KONTEN</h3>
                        ...
                        <div class="col-md-12">
                            <div class="box box-success">
                                ...
                                <div class="box-body pad">
                                    <form action="<?php echo site_url('admin/update-berita');?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="title" id="title" value="<?php echo $berita['title']; ?>" class="form-control news title" required />
                                            </div><!-- /.input group -->
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="author" id="author" value="<?php echo $this->session->userdata('USERNAME'); ?>" class="form-control news title" readonly />
                                            </div><!-- /.input group -->
                                        </div>
                                        <div class="form-group">
