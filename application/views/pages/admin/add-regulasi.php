            ...
            <div class="content-wrapper">
                ...
                <div id="breadcrumb">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Add Regulasi</li>	 
                    </ul>
                </div>
                <div class="main-header-title clearfix">
                    ...
                    <div class="page-title">
                        <h3 class="no-margin">ADD REGULASI</h3>
                        ...
                        <div class="col-md-12">
                            <div class="box box-success">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Add Regulasi</h3>
                                    <!-- tools box -->
                                ...
                                <div class="box-body pad">
                                    <form action="<?php echo site_url('admin/create-regulasi');?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="title_regulasi" id="title" class="form-control news title" required />
                                            </div><!-- /.input group -->
                                        </div>
                                        <div class="form-group">
