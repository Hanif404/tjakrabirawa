            ...
            <div class="content-wrapper">
                ...
                <div id="breadcrumb">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Publish Berita</li>	 
                    </ul>
                </div>
                <div class="main-header-title clearfix">
                    ...
                    <div class="page-title">
                        <h3 class="no-margin">PUBLISH BERITA</h3>
                        ...
                        <div class="col-md-12">
                            <div class="box box-success">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Publish Berita</h3>
                                    <!-- tools box -->
                                ...
                                <div class="box-body pad">
                                    <form action="<?php echo site_url('admin/update-status-berita/'.$berita['id']);?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="album_id" class="form-control" disabled="disabled">
                                                    <?php if ($album): ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="title" id="title" value="<?php echo $berita['title']; ?>" class="form-control news title" readonly />
                                            </div><!-- /.input group -->
                                        </div>
                                        <div class="form-group">
                                            <label>URL :</label>
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="title" id="title" value="<?php echo $berita['url']; ?>" class="form-control" readonly />
                                            </div><!-- /.input group -->
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="kategori" class="form-control" disabled="disabled">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="posisi" class="form-control" disabled="disabled">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="active" class="form-control">
                                                    ...
                                                    <option value="no_active">No Publish</option>
                                                </select>
                                            </div><!-- /.input group -->
                                        </div>
                                        <div class="form-group">
                                            <label>Isi Berita :</label>
                                            <textarea id="editor1" name="isi_berita" rows="10" cols="80"><?php echo $berita['isi_berita']; ?></textarea>
                                        </div>
