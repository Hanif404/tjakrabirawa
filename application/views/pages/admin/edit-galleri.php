            ...
            <div class="content-wrapper">
                ...
                <div id="breadcrumb">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Edit Galleri</li>	 
                    </ul>
                </div>
                <div class="main-header-title clearfix">
                    ...
                    <div class="page-title">
                        <h3 class="no-margin">EDIT GALLERI</h3>
                        ...
                        <div class="col-md-12">
                            <div class="box box-success">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Edit Galleri</h3>
                                    <!-- tools box -->
                                ...
                                <div class="box-body pad">
                                    <form action="<?php echo site_url('admin/update-galleri/'.$galleri['id_galleri']);?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="jdl_gallery" value="<?php echo $galleri['jdl_gallery'];?>" class="form-control" />
                                                </div><!-- /.input group -->
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="editor1" name="keterangan" rows="5" cols="80"><?php echo $galleri['keterangan'];?></textarea>
