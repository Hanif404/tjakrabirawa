            ...
            <div class="content-wrapper">
                ...
                <div class="main-header-title clearfix">
                    ...
                    <div class="page-title">
                        <h3 class="no-margin">EDIT ALBUM</h3>
                        ...
                        <div class="col-md-12">
                            <div class="box box-success">
                                ...
                                <div class="box-body pad">
                                    <form action="<?php echo site_url('admin/update-album/'.$album['id_album']);?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="judul_album" value="<?php echo $album['judul_album'];?>" class="form-control" required />
                                            </div><!-- /.input group -->
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="editor1" name="deskripsi" rows="5" cols="80"><?php echo $album['deskripsi'];?></textarea>
                                        </div>
