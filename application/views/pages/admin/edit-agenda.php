            ...
            <div class="content-wrapper">
                ...
                <div class="main-header-title clearfix">
                    ...
                    <div class="page-title">
                        <h3 class="no-margin">UPDATE AGENDA</h3>
                        ...
                        <div class="col-md-12">
                            <div class="box box-success">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Update Agenda</h3>
                                    <!-- tools box -->
                                ...
                                <div class="box-body pad">
                                    <form action="<?php echo site_url('admin-update-agenda');?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="start_date" class="form-control" value="<?php echo $agenda['start_date']; ?>" id="start_date" placeholder="yyyy/mm/dd" required />
                                            </div><!-- /.input group -->
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="end_date" class="form-control" value="<?php echo $agenda['end_date']; ?>" id="end_date" placeholder="yyyy/mm/dd" required />
                                            </div><!-- /.input group -->
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="nama_agenda" value="<?php echo $agenda['nama_agenda']; ?>" class="form-control" required />
                                            </div><!-- /.input group -->
                                        </div>
                                        <div class="form-group">
                                            <label>Jadwal Dan Acara Kegiatan :</label>
                                            <textarea id="editor1" name="jadwal_kegiatan" rows="10" cols="80"><?php echo $agenda['jadwal_kegiatan']; ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>File :</label>
                                            <div class="input-group">
