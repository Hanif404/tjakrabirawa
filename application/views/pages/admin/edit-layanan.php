                                    ...
                                    <form action="<?php echo site_url('admin/update-layanan/'.$layanan['id_layanan']);?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="title_layanan" value="<?php echo $layanan['title_layanan']; ?>" id="title" class="form-control news title" required />
                                            </div><!-- /.input group -->
                                        </div>
                                        <!--
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="editor1" name="deskripsi" rows="10" cols="80"><?php echo $layanan['deskripsi']; ?></textarea>
                                        </div>
                                        -->
