            ...
            <div class="content-wrapper">
                ...
                <div class="main-header-title clearfix">
                    ...
                    <div class="page-title">
                        <h3 class="no-margin">ADD ALBUM</h3>
                        ...
                        <div class="col-md-12">
                            <div class="box box-success">
                                ...
                                <div class="box-body pad">
                                    <form action="<?php echo site_url('admin/create-album');?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="editor1" name="deskripsi" rows="5" cols="80"></textarea>
                                        </div>
