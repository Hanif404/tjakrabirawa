            ...
            <div class="content-wrapper">
                ...
                <div class="main-header-title clearfix">
                    ...
                    <div class="page-title">
                        <h3 class="no-margin">UPDATE BANNER</h3>
                        ...
                        <div class="col-md-12">
                            <div class="box box-success">
                                ...
                                <div class="box-body pad">
                                    <form action="<?php echo site_url('admin/update-banner');?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="url" name="url" class="form-control" value="<?php echo $banner['url']; ?>" placeholder="http://example.com" required />
                                            </div><!-- /.input group -->
                                        </div>
                                        <div class="form-group">
                                            <label>Display :</label>
                                            <div class="input-group">
                                                ...
                                                <?php
                                                    if (file_exists('asset/img/banner/'.$banner['title'].'-1000x100-'.$banner['image']))
                                                    {
                                                        echo img(array('src'=>base_url('asset/img/banner/'.$banner['title'].'-1000x100-'.$banner['image'])));
                                                    }else{
                                                        echo "no image";
                                                    }
                                                ?>
